	...
	<div class="font-thai -mt-2">
		...
		<div class="container relative mx-auto px-4 font-thai">
			<div class="flex flex-col items-center gap-8 mx-auto px-4">
				<div>
					<h2 class="text-4xl font-bold pt-12">About the Author</h2>
				</div>
				<div class="border-t-2 border-teal-500 w-64"></div>

				<div class="mx-auto px-6 pt-4 pb-12">
					<div class="relative">
						<!-- Top-left border -->
						<div class="absolute bottom-0 left-0">
							<div class="border-l-4 border-teal-500 h-32"></div>
							<div class="border-t-4 border-teal-500 w-32"></div>
						</div>

						<!-- Bottom-right border -->
						<div class="absolute top-0 right-0">
							<div class="border-t-4 border-teal-500 w-32"></div>
							<div class="border-r-4 border-teal-500 h-32"></div>
						</div>

						<!-- Content -->
						<div
							class="flex flex-col gap-6 justify-center items-center py-12 px-4 bg-blue-50"
						>
							<h3 class="text-xl font-bold mb-2 font-merriweather">
							...
							<p class="px-4 text-sm md:text-lg">
								...
								spanning roughly four decades: as a university professor,
								corporate executive, law maker, political critic, religious
								scholar, public speaker and best-selling author. His deep
								interest in eastern religions and metaphysics together with a
								brief period of monkhood, when coupled with his rigorous
								scientific background, culminated in a series of books
